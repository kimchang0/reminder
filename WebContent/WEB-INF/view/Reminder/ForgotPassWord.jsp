      ...
      <div class="container-login100" style="background-color: #f4f3ef">
         <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54 shadowbox">
            <form class="login100-form validate-form"
               action="/Reminder/ReminderReMakePW.do" method="post">
               <div id="flexbox">
               ...
               <div class="wrap-input100 validate-input m-b-23"
                  ...
                  <span class="label-input100">Email</span> <input
                     ...
                     placeholder="가입 시 인증한 이메일 주소를 입력해주세요." /> <span class="focus-input100"
                     data-symbol="&#xf206;"></span>
               </div>
               ...
               <div class="container-login100-form-btn">
                  <div class="wrap-login100-form-btn">
                     ...
                     <button type="submit" class="login100-form-btn btn">confirm</button>
                  </div>
               </div>
            </form>
         </div>
