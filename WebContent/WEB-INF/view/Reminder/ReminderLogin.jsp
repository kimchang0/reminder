      ...
      <div class="container-login100" style="background-color: #f4f3ef">
         <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54 shadowbox">
            <form class="login100-form validate-form"
               action="/Reminder/ReminderLoginProc.do" method="post">
               <div id="flexbox">
               ...
               <div class="text-right">
                  <a href="/Reminder/ForgotPassWord.do"> Forgot password? </a>
               </div>
               ...
               <div class="flex-col-c p-t-155" style="padding-top: 30px">
                  <a href="/Reminder/ReminderSignUp.do" class="txt2"> Sign Up </a>
               </div>
            </form>
         </div>
      </div>
